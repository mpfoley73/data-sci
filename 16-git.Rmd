...
Install Git from [www.git-scm.com](https://www.git-scm.com/). After installing, open Git bash.

> git -- version

Navigate to your project folder.

> cd ~/OneDrive/Documents/GitHub/nlp
> ls
...
You can commit all fies without staging with -a
