...
The likelihood ratio, $G^2 = 18.658$, so reject the null hypothesis of no sex effect - there is statistically significant difference in pass rates.  Here are the coefficient estimators.
