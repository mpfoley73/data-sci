...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Binomial Distribution"}\NormalTok{, }
       \DataTypeTok{subtitle =} \KeywordTok{paste0}\NormalTok{(}
         \StringTok{"P(X=2) successes in 10 trials when p = 0.3 is "}\NormalTok{, }
         \KeywordTok{round}\NormalTok{(}\KeywordTok{dbinom}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{10}\NormalTok{, }\FloatTok{0.3}\NormalTok{), }\DecValTok{4}\NormalTok{), }\StringTok{"."}
\NormalTok{       ),}
...
Dataset \texttt{leuk} contains response variable \texttt{REMISS} indicating whether leukemia remission occurred (1\textbar0) and several explanatory variables.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pred <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(m1, }\DataTypeTok{newdata =} \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{CELL =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{CELL),}
                                         \DataTypeTok{SMEAR =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{SMEAR),}
                                         \DataTypeTok{INFIL =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{INFIL),}
                                         \DataTypeTok{LI =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{LI),}
                                         \DataTypeTok{BLAST =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{BLAST),}
                                         \DataTypeTok{TEMP =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{TEMP)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prob <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(m1, }\DataTypeTok{newdata =} \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{CELL =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{CELL),}
                                         \DataTypeTok{SMEAR =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{SMEAR),}
                                         \DataTypeTok{INFIL =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{INFIL),}
                                         \DataTypeTok{LI =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{LI),}
                                         \DataTypeTok{BLAST =} \KeywordTok{mean}\NormalTok{(leuk}\OperatorTok{$}\NormalTok{BLAST),}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{exp}\NormalTok{(.}\DecValTok{1} \OperatorTok{*}\StringTok{ }\NormalTok{m1}\OperatorTok{$}\NormalTok{coefficients)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{augment}\NormalTok{(m1, }\DataTypeTok{type.predict =} \StringTok{"response"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ LI, }\DataTypeTok{y =}\NormalTok{ REMISS)) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"LI"}\NormalTok{,}
       \DataTypeTok{y =} \StringTok{"Probability of Event"}\NormalTok{,}
       \DataTypeTok{title =} \StringTok{"Binary Fitted Line Plot"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{round}\NormalTok{((z <-}\StringTok{ }\NormalTok{m1}\OperatorTok{$}\NormalTok{coefficients }\OperatorTok{/}\StringTok{ }\KeywordTok{summary}\NormalTok{(m1)}\OperatorTok{$}\NormalTok{coefficients[,}\StringTok{"Std. Error"}\NormalTok{]), }\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{augment}\NormalTok{(m1) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{data.frame}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{GainCurvePlot}\NormalTok{(}\DataTypeTok{xvar =} \StringTok{".fitted"}\NormalTok{, }\DataTypeTok{truthVar =} \StringTok{"REMISS"}\NormalTok{, }\DataTypeTok{title =} \StringTok{"Logistic Model"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{colAUC}\NormalTok{(m1}\OperatorTok{$}\NormalTok{fitted.values, m1}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{REMISS, }\DataTypeTok{plotROC =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fire <-}\StringTok{ }\NormalTok{fire }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mo =} \KeywordTok{as.POSIXlt}\NormalTok{(}\StringTok{`}\DataTypeTok{Injury Date}\StringTok{`}\NormalTok{)}\OperatorTok{$}\NormalTok{mon }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{dt =} \StringTok{`}\DataTypeTok{Injury Date}\StringTok{`}\NormalTok{,}
         \DataTypeTok{injuries =} \StringTok{`}\DataTypeTok{Total Injuries}\StringTok{`}\NormalTok{)}
\KeywordTok{str}\NormalTok{(fire)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(fire}\OperatorTok{$}\NormalTok{injuries)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var}\NormalTok{(fire}\OperatorTok{$}\NormalTok{injuries)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{augment}\NormalTok{(m2, }\DataTypeTok{type.predict =} \StringTok{"response"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ mo, }\DataTypeTok{y =}\NormalTok{ injuries)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ .fitted), }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Month"}\NormalTok{,}
       \DataTypeTok{y =} \StringTok{"Injuries"}\NormalTok{,}
       \DataTypeTok{title =} \StringTok{"Poisson Fitted Line Plot"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(perf <-}\StringTok{ }\KeywordTok{glance}\NormalTok{(m2))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(pseudoR2 <-}\StringTok{ }\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{perf}\OperatorTok{$}\NormalTok{deviance }\OperatorTok{/}\StringTok{ }\NormalTok{perf}\OperatorTok{$}\NormalTok{null.deviance)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{RMSE}\NormalTok{(}\DataTypeTok{pred =} \KeywordTok{predict}\NormalTok{(m2, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{), }\DataTypeTok{obs =}\NormalTok{ fire}\OperatorTok{$}\NormalTok{injuries)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{augment}\NormalTok{(m2, }\DataTypeTok{type.predict =} \StringTok{"response"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ injuries, }\DataTypeTok{y =}\NormalTok{ .fitted)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =}\StringTok{"lm"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Actual"}\NormalTok{,}
       \DataTypeTok{y =} \StringTok{"Predicted"}\NormalTok{,}
       \DataTypeTok{title =} \StringTok{"Poisson Fitted vs Actual"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{augment}\NormalTok{(m2) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{data.frame}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{GainCurvePlot}\NormalTok{(}\DataTypeTok{xvar =} \StringTok{".fitted"}\NormalTok{, }\DataTypeTok{truthVar =} \StringTok{"injuries"}\NormalTok{, }\DataTypeTok{title =} \StringTok{"Poisson Model"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Finishing the CP table tour, \texttt{xerror} is the relative cross-validated error rate and \texttt{xstd} is its standard error. If you want the lowest possible error, then prune to the tree with the smallest relative CV error (\texttt{xerror}) (\(c_p\) = 0.01, CV error = 0.18). If you want to balance predictive power with simplicity, prune to the smallest tree within 1 SE of the one with the smallest relative error. The CP table is not super-helpful for finding that tree. I'll add a column to find it.
...
\includegraphics{data-sci_files/figure-latex/unnamed-chunk-110-1.pdf}
...
\includegraphics{data-sci_files/figure-latex/unnamed-chunk-114-1.pdf}
...
\includegraphics{data-sci_files/figure-latex/unnamed-chunk-117-2.pdf}
...
\includegraphics{data-sci_files/figure-latex/unnamed-chunk-120-1.pdf}
...
\includegraphics{data-sci_files/figure-latex/unnamed-chunk-120-2.pdf}
...
\includegraphics{data-sci_files/figure-latex/unnamed-chunk-121-2.pdf}
...
\NormalTok{train_data <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(x, y)}
\NormalTok{train_data}\OperatorTok{$}\NormalTok{y <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(y)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m}\OperatorTok{$}\NormalTok{index}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m_best <-}\StringTok{ }\NormalTok{m_tune}\OperatorTok{$}\NormalTok{best.model}
\KeywordTok{summary}\NormalTok{(m_best)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train_data_}\DecValTok{2}\NormalTok{ <-}\StringTok{ }\NormalTok{train_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{X1 =}\NormalTok{ X1 }\OperatorTok{+}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(y}\OperatorTok{==}\DecValTok{1}\NormalTok{, }\FloatTok{1.0}\NormalTok{, }\DecValTok{0}\NormalTok{),}
    \DataTypeTok{X2 =}\NormalTok{ X2 }\OperatorTok{+}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(y}\OperatorTok{==}\DecValTok{1}\NormalTok{, }\FloatTok{1.0}\NormalTok{, }\DecValTok{0}\NormalTok{)}
\NormalTok{  )}
\KeywordTok{ggplot}\NormalTok{(train_data_}\DecValTok{2}\NormalTok{, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ X1, }\DataTypeTok{y =}\NormalTok{ X2, }\DataTypeTok{color =}\NormalTok{ y)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Binary response with two features, linearly separable"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m3_best <-}\StringTok{ }\NormalTok{m3_tune}\OperatorTok{$}\NormalTok{best.model}
\KeywordTok{summary}\NormalTok{(m3_best)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{data-sci_files/figure-latex/unnamed-chunk-140-1.pdf}

\hypertarget{using-caret}{%
\section{Using Caret}\label{using-caret}}

The model can also be fit using \textbf{caret}. I'll used LOOCV since the data set is so small. Normalize the variables to make their scale comparable.
...
\NormalTok{train_data_}\DecValTok{3}\NormalTok{ <-}\StringTok{ }\NormalTok{train_data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{y =} \KeywordTok{factor}\NormalTok{(y, }\DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"A"}\NormalTok{, }\StringTok{"B"}\NormalTok{)))}

\NormalTok{m4 <-}\StringTok{ }\KeywordTok{train}\NormalTok{(}
\NormalTok{  y }\OperatorTok{~}\StringTok{ }\NormalTok{.,}
  \DataTypeTok{data =}\NormalTok{ train_data_}\DecValTok{3}\NormalTok{,}
  \DataTypeTok{method =} \StringTok{"svmPoly"}\NormalTok{,}
  ...
  \DataTypeTok{trControl =} \KeywordTok{trainControl}\NormalTok{(}
    ...
    \DataTypeTok{summaryFunction =}\NormalTok{ twoClassSummary,  }\CommentTok{# Use AUC to pick the best model}
    \DataTypeTok{classProbs=}\OtherTok{TRUE}
\NormalTok{  )}
\NormalTok{)}

\NormalTok{m4}\OperatorTok{$}\NormalTok{bestTune}
\end{Highlighting}
\end{Shaded}
...
\addcontentsline{toc}{section}{Publishing to BookDown}
...
\addcontentsline{toc}{subsection}{Create a package}
...
\addcontentsline{toc}{subsection}{Create Data}
...
\addcontentsline{toc}{subsection}{Create Vignette}
...
\addcontentsline{toc}{subsubsection}{Step 2: Create an R Markdown template}
