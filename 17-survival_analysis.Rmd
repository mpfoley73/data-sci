...
```{r}
ggsurvplot(survfit(lung_cox_2, data = lung), 
           palette = "#2E9FDF", ggtheme = theme_minimal())
```
...
lung_pred <- survfit(lung_cox_2, newdata = newdata)
ggsurvplot(survfit(lung_cox_2, newdata = newdata), data = lung,
           conf.int = TRUE, 
