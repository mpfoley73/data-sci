...
For the smoking study, you might ask whether a person is more likely to smoke if *either* parent smokes.  Collapse the first two rows (1 parent smokes, both parents smoke) and run the chi-squared test.

```{r}
smoke_clps_1 <- matrix(smoke_o[1, ] + smoke_o[2, ])
```
