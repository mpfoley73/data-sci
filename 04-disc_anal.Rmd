...
A one-way frequency table is a frequency table for a single categorical table.  You usually construct a one-way table to test whether the frequency counts conform to a hypothesized distribution using the chi-squared goodness-of-fit test.
