...
These notes rely heavily upon PSU STAT 504 [online notes](https://online.stat.psu.edu/stat504/node/60/).
...
If the saturated model (the observed data represent the fit of the saturated model, the most complex model possible with the given data) proportions $p_j$ equal equal the expected proportions $\pi_j$, 
