...
If you have free-form text in a column with other descriptive columns you can group word counts by dimension. An example of a data set like this is the Russion tweet data set.

```{r cache=TRUE, message=FALSE, warning=FALSE}
tweets <- read_csv(url("https://github.com/fivethirtyeight/russian-troll-tweets/raw/master/IRAhandle_tweets_1.csv")) %>%
  head(n = 20000)
glimpse(tweets)
```
...
Get rid of other garbage words by adding custom stop_words.
